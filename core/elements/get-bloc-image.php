<?php 
	...
	function get_bloc_image(){
		...
		$fluxi_content_image .= '<a href="'.$image_only['sizes']['large'].'" class="js-is-lightbox"><figure class="c-figure"><img class="c-figure__img" src="'.$image_only['sizes']['large'].'" alt="'.$image_only['name'].'" />';
